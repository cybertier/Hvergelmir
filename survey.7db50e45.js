...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/survey.js":[function(require,module,exports) {
...
var url = "https://85.215.38.177:9452";
...
function getSavedOrderDescriptions(relevant_cookie) {
  var key = relevant_cookie + "_descriptions";
  return JSON.parse(localStorage.getItem(key));
}
function getSavedOrderNames(relevant_cookie) {
  var key = relevant_cookie + "_names";
  return JSON.parse(localStorage.getItem(key));
}
...
function _sendJSON() {
  _sendJSON = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", fetch("https://hvergelmir.ddns.net:9452", {
            method: "POST",
...
function saveData(e, type, redirection_target, is_first) {
  ...
  var addBrowser = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
  e.preventDefault();
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/survey.js"], null)
//# sourceMappingURL=/survey.7db50e45.js.map